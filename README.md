# 🛡️ Pashov Audit Group Smart Contract Security Audits

[www.pashov.net](https://www.pashov.net/)  
Reach out on [Telegram @pashovkrum](https://t.me/pashovkrum)
...
- [Gigaverse - game](team/pdf/Gigaverse-security-review_2025-01-18.pdf) <span style="background:#fff3e0; color:#ef6c00; padding:3px 8px; border-radius:5px;">Game</span>

## 🔄 Stablecoins
- [Ethena - synthetic dollar](team/pdf/Ethena-security-review.pdf) <span style="background:#e1f5fe; color:#0277bd; padding:3px 8px; border-radius:5px;">Stablecoin</span>
- [Roots - CDP stablecoin](team/pdf/Roots-security-review_2025-02-09.pdf) <span style="background:#e1f5fe; color:#0277bd; padding:3px 8px; border-radius:5px;">Stablecoin</span>

## 🌉 Layer 2
- [Reya Network - modular L2](team/pdf/ReyaNetwork-security-review-April.pdf) <span style="background:#ede7f6; color:#5e35b1; padding:3px 8px; border-radius:5px;">L2</span>
- [BOB - hybrid layer 2](team/pdf/BOB-security-review-August.pdf) <span style="background:#ede7f6; color:#5e35b1; padding:3px 8px; border-radius:5px;">L2</span>
